...
// get data
async function GetProductStudio() {
    const datas = await GetData("productStudios")
    console.log(datas)
    return (
        <div className="grid grid-cols-4">

            {datas.product_studio.map((data: { type_product: number, name_product: string, price_product: number, display_product: string }) => (
...
export default GetProductStudio